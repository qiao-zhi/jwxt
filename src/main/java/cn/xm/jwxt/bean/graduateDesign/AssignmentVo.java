...
public class AssignmentVo {
    ...
    public void setStudenttitleresultid(String studenttitleresultid) {
        this.studenttitleresultid = studenttitleresultid;
    }
    ...
    public void setDesigntargetrequire(String designtargetrequire) {
        this.designtargetrequire = designtargetrequire;
    }
    ...
    public void setDesignsubmitfile(String designsubmitfile) {
        this.designsubmitfile = designsubmitfile;
    }
    ...
    public String getTeamworkStudentName() {
        return teamworkStudentName;
    }

    public void setTeamworkStudentName(String teamworkStudentName) {
        this.teamworkStudentName = teamworkStudentName;
    }
}
