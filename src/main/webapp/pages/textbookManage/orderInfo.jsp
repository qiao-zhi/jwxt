...
<div class="x-body">
    ...
    <xblock>
        ...
        <button class="layui-btn" onclick="checkOrder()">审核订单 </button>
        <button class="layui-btn" onclick="commitToDean()">提交至教学院长 </button>
        <button class="layui-btn" onclick="checkInfo()">查看审核信息 </button>
		    ...
		    <script>
				var chooseCourse=0;//判断是否选中课程
			    	...
			    	function checkOrder(){
			    		panduan();//调用判断方法
			    		if (chooseCourse>0) {
										x_admin_show('审核订单','./orderInfo-deanCheck.html')
									}
			    		else{
			    	...
			    	function checkInfo(){
			    		panduan();//调用判断方法
			    		if (chooseCourse>0) {
			    			x_admin_show('查看审核信息','./orderInfo-viewCheckInfo.html')
									}
			    		else{
