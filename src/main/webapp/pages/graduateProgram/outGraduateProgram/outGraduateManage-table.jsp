	...
	<div class="layui-tab">
	  <ul class="layui-tab-title">
	    ...
	    <div style="margin-top: 5px;">
	    	<button onclick="checkCommit()" class="layui-btn" style="float: right;">提交</button>
    		<button onclick="checkSave()" class="layui-btn" style="float: right; margin-right: 10px;">保存</button>
	    </div>
  ...
  <div class="layui-tab-content">
    	...
    	<form action="" class="layui-form">
		    <table class="table table-bordered ">
		        ...
		        <tr>
		            ...
		            <td>接收单位名称</td>
		            <td colspan="3">
		                <input type="text" style="width: 560px;" class="form-control">
		            </td>
		        </tr>
		        ...
		        <tr>
		            ...
		            <td colspan="3">
		                ...
		                <textarea name="" cols="100" rows="4" class="form-control"></textarea>
		            </td>
		            <td>
		            ...
		            <td colspan="1">
		            	<div style="height: 40px;">
		            		<img src="../../../images/bg.png" width="165px" height="50px"/>
		            		<input onclick="studentSign()"  class="layui-btn" id="" style="float: right; width: 65px;" value="签名"></input>
		            	</div>
		                <hr />
		                <input type="datetime" id="applytime" placeholder="2018-04-25" class="form-control">
		            </td>
		        </tr>
		        <!--家长意见-->
		        <tr>
		            ...
		            <td colspan="3">
		            	<div>
		            		<input type="radio" name="opinion" id="opinion" value="" title="同意"/>
		            		<input type="radio" name="opinion" id="opinion" value="" title="不同意"/>
		            	</div>
		            ...
		            <td colspan="1">
		            	<div style="height: 40px;">
		            		<img src="../../../images/bg.png" width="170px" height="50px"/>
		            		<input onclick="testtest()" type="button" class="layui-btn" id="test1" style="float: right; width: 65px;" value="签名"></input>
		            	</div>
		                <hr />
		                <input type="datetime" id="applytime1" placeholder="2018-04-25" class="form-control">
		            </td>
		        ...
		        <tr>
		            ...
		            <td colspan="1">
		                ...
		                <hr />
		                <input type="datetime" id="applytime2" placeholder="2018-04-25" class="form-control">
		            </td>
		        ...
		        <tr>
		            ...
		            <td colspan="1">    
		                ...
		                <hr />
		                <input type="datetime" id="applytime3" placeholder="2018-04-25" class="form-control">
		            </td>
		        ...
		        <tr>
		            ...
		            <td colspan="1">    
		                ...
		                <hr />
		                <input type="datetime" id="applytime4" placeholder="2018-04-25" class="form-control">
		            </td>
		         ...
		         <tbody>
		            ...
		            <tr>
		             ...
		             <tr>
		                <td>课题简介</td>
		                <td colspan="6">
		                    <textarea class="layui-textarea form-control" name=""></textarea>
		                </td>
		            </tr>
		            <tr>
		                <td>实践内容</td>
		                <td colspan="6">
		                    <textarea name="" class="layui-textarea form-control"></textarea>
		                </td>
		            </tr>
		             <tr>
		                <td>实践要求</td>
		            ...
		            <tr>
		                ...
		                <td colspan="6">
		                    ...
		                    <input type="radio" name="resultType" lay-skin="primary" title="报告">
		                    </div>
		                    <div class="layui-inline">
		                    <label for="L_pass" class="layui-form-label">
		                        E
		            ...
		            <td colspan="3" >
		            	<div style="height: 50px; width: 230px;">
		            		...
		            		<input onclick="tutorSign()" value="签名" type="button" class="layui-btn" id="test1" style="float: right;"></input>
		            	</div>
		                <hr />
		                <input type="datetime" id="applytime6" placeholder="2018-04-25" class="form-control">
		            </td>
    ...
    <table class="table table-bordered ">
        ...
        <tr>
            ...
            <td width="450px">
            	<input id="applytimeRange" type="text" name="" placeholder="点击选择请假日期" autocomplete="off" class="form-control" >
            </td>
            <td>请假天数</td>
            <td colspan="3">
        ...
        <tr>
         ...
         <tr>
            ...
            <td colspan="2">
            	<div style="height: 50px;">
            		<img src="../../../images/bg.png" width="160px" height="50px"/>
            		<button type="button" class="layui-btn" id="test1" style="float: right;">签名</button>
            	</div>
                <hr />
                <input type="datetime" id="applytime2" placeholder="2018-04-25" class="form-control">
       ...
       <tr>
        ...
        <tr>
            ...
            <td colspan="2">
            	<div style="height: 50px; width: 170px;">
            		<img src="../../../images/bg.png" width="160px" height="50px"/>
            		<button type="button" class="layui-btn" id="test1" style="float: right;margin-right: -59px;">签名</button>
            	</div>
                <hr />
                <input type="datetime" id="applytime2" placeholder="2018-04-25" class="form-control">
            </td>
        ...
        <tr>
        	<td>销假日期</td>
            <td  width="100px">
            	<input type="text" id="applytimeCancel" class="form-control" />
            </td>
