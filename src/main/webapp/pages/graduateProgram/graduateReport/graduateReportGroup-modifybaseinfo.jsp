...
<div class="x-body">
    ...
    <form class="layui-form">
        ...
        <input type="hidden" name="pleaid" value="${tTeacherInfoVo.pleaid}"/>
...
<script>
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(update)', function (data) {
            $.ajax({
                type:'POST',
                url:"${pageContext.request.contextPath}/gradesigncheckgroup/updateNew.action?gradesigncheckgrouopInfo="+JSON.stringify(data.field),
                dataType:'JSON',
