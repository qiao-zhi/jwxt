...
<div class="x-body" style="margin:20px auto 50px auto; width:70%;">
    ...
    <table class="layui-table">
        ...
        <tr>
            ...
            <td>
                ...
                <button class="layui-btn layui-btn-sm">审核</button>
                <button class="layui-btn layui-btn-sm layui-btn-normal">查看</button>
                <button class="layui-btn layui-btn-sm layui-btn-danger">审核不通过</button>
            </td>
        </tr>
        </tbody>
    </table>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>主管院长签名</td>
            <td>
                <button type="button" class="layui-btn" id="test13">上传签名</button>
                <div class="layui-upload-list">
                    <img class="layui-upload-img" width="100" id="demo13">
                    <p id="demoTex3t"></p>
                </div>
            </td>
        </tr>
