...
<body>
<div class="x-body">
    <c:set var="gradesigncheckgroup" value="${gradesigncheckgroup}"/>
    <c:set var="checkgrouppersonLeaderList" value="${checkgrouppersonLeaderList}"/>

    <form class="layui-form">
        <!--2-->
        <input type="hidden" name="groupid" value="${gradesigncheckgroup.groupid}"/>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="titlename" name="groupname" required="" lay-verify="required"
                       value="${gradesigncheckgroup.groupname}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="teacherName" name="replyaddress" required="" lay-verify="required"
                       value="${gradesigncheckgroup.replyaddress}"
                       autocomplete="off" class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">
                必须填写
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="replytime" id="L_pass" placeholder="yyyy-MM-dd HH:mm:ss"/>
            </div>
        </div>
        <!--5-->
        <div class="layui-form-item">
