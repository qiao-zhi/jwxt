...
function showTaskNoticeBaseInfo(pageInfo){
    ...
    for(var i=0,length_l = baseInfoList.length;i<length_l;i++){
        ...
        var tr =
            ...
            '</td>' +
            '<td>' + checkNull(baseInfoList[i].studentName) + '</td>' +
            '<td>' + checkNull(baseInfoList[i].studentSex) + '</td>' +
            '<td>' + checkNull(baseInfoList[i].className) + '</td>' +
            '<td>' + checkNull(baseInfoList[i].teacherName1) + '|' +  checkNull(baseInfoList[i].titlename1) + '</td>' +  /*通过，firstTeacherTitleId 查询课题名称和教师*/
            '<td>' + checkNull(baseInfoList[i].teacherName2) + '|' +  checkNull(baseInfoList[i].titlename2) + '</td>' +  /*通过，secondTeacherTitleId 查询课题名称和教师*/
